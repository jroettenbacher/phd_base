...
# %% set variables
# field_folder = "ASP_06_transfer_calib_20210604"  # transfer calib folder
field_folder = "ASP_07_transfer_calib_20210607"  # transfer calib folder
...
lab_cali_files = [f for f in os.listdir(calib_path) if f.endswith("lab_calib.dat")]
...
for field_file in field_cali_files:
    ...
    ax.grid()
    plt.tight_layout()
    figname = f"{plot_path}/{date_str}_{spectrometer}_{direction}_{channel}_ulli_transfer_calib.png"
    ...
    # %% write output file
    outfile = f"{calib_path}/{date_str}_{spectrometer}_{direction}_{channel}_transfer_calib.dat"
