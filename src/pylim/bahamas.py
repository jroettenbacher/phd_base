...
plot_props = dict(Flight_20210624a=dict(figsize=(9.5, 9), cb_loc="left", shrink=1, l_loc=1),
                  ...
                  RF16=dict(figsize=(7.8, 9), cb_loc="bottom", shrink=1, l_loc=3),
                  RF17=dict(figsize=(7.8, 9), cb_loc="bottom", shrink=1, l_loc=3),
                  RF18=dict(figsize=(7.8, 9), cb_loc="bottom", shrink=1, l_loc=3))
