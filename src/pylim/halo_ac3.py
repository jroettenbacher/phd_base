...
transfer_calibs = dict(RF00_20220221="20220222", RF01_20220225="20220222")

take_offs_landings = dict(RF00_20220221=(Ts(2022, 2, 21, 10, 25), Ts(2022, 2, 21, 13, 42)),
                          RF01_20220225=(Ts(2022, 2, 25, 7, 30), Ts(2022, 2, 25, 12, 13)))

# GoPro time offset to BAHAMAS
gopro_offsets = dict(RF00_20220221=-2, RF01_20220225=24)
