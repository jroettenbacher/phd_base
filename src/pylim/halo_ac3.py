...
cloudy_times = dict(
    RF17=dict(high=dict(starts=[Ts(2022, 4, 11, 8, 30), Ts(2022, 4, 11, 9, 43), Ts(2022, 4, 11, 12, 15)],
                        ends=[Ts(2022, 4, 11, 8, 52), Ts(2022, 4, 11, 11, 7), Ts(2022, 4, 11, 14, 4)]),
              low=dict(starts=[Ts(2022, 4, 11, 8, 30), Ts(2022, 4, 11, 9, 41), Ts(2022, 4, 11, 13, 37),
                               Ts(2022, 4, 11, 13, 58)],
                       ends=[Ts(2022, 4, 11, 9, 14), Ts(2022, 4, 11, 9, 44), Ts(2022, 4, 11, 13, 55),
                             Ts(2022, 4, 11, 14, 4)])
              )
)
