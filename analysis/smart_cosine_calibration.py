...
.. deprecated:: 16.11.2021
    The measurements were done with the inlets switched and not all measurements were performed so it was
    decided to repeat the whole calibration (see :ref:`analysis:smart_cosine_calibration_v2.py`).
    This script is kept for archiving only.
...
- :file:`{angle}_turned`: The inlet was turned 90deg around the horizontal axis to evaluate all four azimuth directions
