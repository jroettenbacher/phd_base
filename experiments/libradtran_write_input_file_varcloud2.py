...
This run uses the Yang ice optic parameterization.
...
if __name__ == "__main__":
    ...
    for timestamp in tqdm(timestamps, desc="Write input files"):
        ...
        re_ice = (varcloud_sel["Varcloud_Cloud_Ice_Effective_Radius"] * 1e6).to_numpy()
